...
def prop_run():
    ...
    # 유저가 원하는 값 입력
    st.write('2019 / 5 / 7 부터 2024 / 5 / 6 까지의 데이터를 기준으로 예측합니다')
    st.write('2024 / 5 / 7 부터의 추세를 예측합니다.')
    pro_text = st.number_input('추세 예측을 하기 위해 원하는 기간을 입력해주세요. 7일 부터 365일까지 입력 가능합니다.', min_value = 30, value = 90, max_value = 365, step = 7)  # 기본값을 100으로 설정
